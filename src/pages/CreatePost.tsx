...
const CreatePost = () => {
    ...
    return (  
        <div className="p-6" onClick={()=>{ setError(""); setSuccess("") }}>
            {loading && <Loading/>}
            <div className="space-y-8 px-8 py-6 border-2 border-mainGrey max-w-[700px] mx-auto rounded-xl">
                <h1 className="text-center font-bold sm:text-4xl text-3xl text-mainBlue">Create Post</h1>
                ...
                <form onSubmit={ handleSubmit }>
                    <div>
                        <label>Title</label>
                        <input type="text" placeholder="Post title...." className="mt-1 input"
                        onChange={e => titleRef.current= e.target.value}/>
                    </div>
                    <div className="mt-3">
                        <label>Description</label>
                        <input type="text" placeholder="Post description ..." className="mt-1 input"
