            ...
            <form onSubmit={handleSubmit}>
                <div className="flex gap-4 justify-between px-8 py-6 border-mainGrey border-y-2">
                    <div>
                        ...
                        <button type="button" className="button" onClick={ () => fileInputRef.current.click() }>upload picture</button>
                ...
                <div className="px-8 py-6">  
                    ...
                    <input type="text" placeholder="Enter your password here" className="mt-1 input" defaultValue={currentUser?.displayName as string}
